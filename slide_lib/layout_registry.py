...
def _contract(name: str, slots: tuple[str, ...] = (), *, root: bool = False,
		...
		continuation: bool = False, decompose: bool = False,
	...
	result = slide_lib.layout_primitives.LayoutContract(
		...
		allows_subtitle=subtitle, vertical_title=vertical_title,
		vertical_slots=vertical_slots, topology_matchable=matchable,
		topology_slots=_topology(name) if matchable else (),
		continuation_policy=slide_lib.layout_primitives.ContinuationPolicy.ALLOW if continuation else
...
LAYOUT_CONTRACTS = {
	...
	"one-panel": _contract("one-panel", ("body",), root=True, title=True, matchable=True,
		continuation=True, libreoffice=LibreOfficeAutoLayout.TITLE_CONTENT,
		placeholders=((LibreOfficePlaceholder.TITLE, "title"),
	...
	"two-panels": _contract("two-panels", ("left", "right"), title=True, matchable=True,
		decompose=True, libreoffice=LibreOfficeAutoLayout.TITLE_2CONTENT,
		placeholders=((LibreOfficePlaceholder.TITLE, "title"),
	...
	"one-plus-two-panels": _contract("one-plus-two-panels", ("left", "top-right", "bottom-right"),
		title=True, matchable=True, decompose=True,
	...
	"six-panels": _contract("six-panels", ("top-left", "top-center", "top-right",
		...
		placeholders=((LibreOfficePlaceholder.TITLE, "title"),
			...
			(LibreOfficePlaceholder.OUTLINE, "bottom-right"))),
	"vertical-panel": _contract("vertical-panel", ("body",), root=True, title=True,
		vertical_title=True, vertical_slots=("body",),
		libreoffice=LibreOfficeAutoLayout.VERTICAL_TITLE_VERTICAL_CONTENT,
		placeholders=((LibreOfficePlaceholder.VERTICAL_TITLE, "title"),
			(LibreOfficePlaceholder.VERTICAL_OUTLINE, "body"))),
	"vertical-title-two-panels": _contract("vertical-title-two-panels", ("text", "chart"),
		title=True, vertical_title=True, vertical_slots=("text",),
		libreoffice=LibreOfficeAutoLayout.VERTICAL_TITLE_VERTICAL_CONTENT_OVER_VERTICAL_CONTENT,
		placeholders=((LibreOfficePlaceholder.VERTICAL_TITLE, "title"),
			(LibreOfficePlaceholder.VERTICAL_OUTLINE, "text"),
			(LibreOfficePlaceholder.OUTLINE, "chart"))),
	"vertical-text-panel": _contract("vertical-text-panel", ("body",), root=True, title=True,
		vertical_slots=("body",), libreoffice=LibreOfficeAutoLayout.TITLE_VERTICAL_CONTENT,
		placeholders=((LibreOfficePlaceholder.TITLE, "title"),
			(LibreOfficePlaceholder.VERTICAL_OUTLINE, "body"))),
	"two-panels-vertical-clipart": _contract("two-panels-vertical-clipart", ("left", "right"),
		title=True, vertical_slots=("left", "right"),
		libreoffice=LibreOfficeAutoLayout.TITLE_2VERTICAL_CONTENT,
		placeholders=((LibreOfficePlaceholder.TITLE, "title"),
			(LibreOfficePlaceholder.GRAPHIC, "left"),
			(LibreOfficePlaceholder.VERTICAL_OUTLINE, "right"))),
